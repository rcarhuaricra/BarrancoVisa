...
<html lang="es">
    <head>
        ...
        <script src="<?php echo base_url('recursos/'); ?>jquery.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url('recursos/'); ?>jquery-1.11.1.min.js" type="text/javascript"></script>
