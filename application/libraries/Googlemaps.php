...
class Googlemaps {
    ...
    var $apiKey = 'AIzaSyCjdnXq5pQ5Rhmv89wfTqpS5I4_62jFw9E';       // If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
    ...
    var $center = "-12.1049705, -77.0404675";  // Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
